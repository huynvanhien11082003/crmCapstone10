					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:if test="${pm.status eq 'Chưa bắt đầu'}">
										<a href="#">
											<div class="mail-contnet">
												<h5>${pm.taskName}</h5>
												<span class="mail-desc">Tiến độ: ${pm.percent}%</span>
											</div>
										</a>
									</c:if>
								</div>
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:if test="${pm.status eq 'Đang thực hiện'}">
										<a href="#">
											<div class="mail-contnet">
												<h5>${pm.taskName}</h5>
												<span class="mail-desc">Tiến độ: ${pm.percent}%</span>
						...
						<div class="col-md-4">
							<div class="white-box">
								...
								<div class="message-center">
									<c:if test="${pm.status eq 'Hoàn thành'}">
										<a href="#">
											<div class="mail-contnet">
												<h5>${pm.taskName}</h5>
												<span class="mail-desc">Tiến độ: ${pm.percent}%</span>
