								...
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${list}" var="items">
											<tr>
												<td>${items.id}</td>
												<td>${items.taskid.nameTasks}</td>
												<td>${items.taskid.projectsid.name}</td>
												<td>${items.usersid.firstname} ${items.usersid.lastname}</td>
												<td>${items.startDate}</td>
												<td>${items.endDate}</td>
												<td>${items.status}</td>
												<td><a href="task-edit?id=${items.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="task-delete?id=${items.id}" class="btn btn-sm btn-danger">Xóa</a> <a
