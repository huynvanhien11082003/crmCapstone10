			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="role-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${rolesList}" var="items">
											<tr>
												<td>${items.id}</td>
												<td>${items.name}</td>
												<td>${items.description}</td>
												<td><a href="role-edit?id=${items.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="role-delete?id=${items.id}" class="btn btn-sm btn-danger">Xóa</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
