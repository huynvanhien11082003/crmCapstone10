			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="user-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${listUsers}" var="items">
											<tr>
												<td>${items.id}</td>
												<td>${items.firstname}</td>
												<td>${items.lastname}</td>
												<td>${items.username}</td>
												<td>${items.rolesid.id}</td>
												<td><a href="user-edit?id=${items.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="user-delete?id=${items.id}" class="btn btn-sm btn-danger">Xóa</a> <a
													href="user-detail?id=${items.id}" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
