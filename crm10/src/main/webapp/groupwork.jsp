			...
			<div class="container-fluid">
				<div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
						<a href="groupwork-add" class="btn btn-sm btn-success">Thêm
							mới</a>
					</div>
					<!-- /.col-lg-12 -->
				</div>
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${projectList}" var="items">
											<tr>
												<td>${items.id}</td>
												<td>${items.name}</td>
												<td>${items.startdate}</td>
												<td>${items.enddate}</td>
												<td><a href="groupwork-edit?id=${items.id}" class="btn btn-sm btn-primary">Sửa</a>
													<a href="groupwork-delete?id=${items.id}" class="btn btn-sm btn-danger">Xóa</a> 
													<a href="groupwork-detail?id=${items.id}" class="btn btn-sm btn-info">Xem</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
