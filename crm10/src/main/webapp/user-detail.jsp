			...
			<div class="container-fluid">
							...
							<div class="user-bg">
								...
								<div class="overlay-box">
									<div class="user-content">
										...
										<h4 class="text-white">${users.lastname}</h4>
										<h5 class="text-white">${users.username}</h5>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<c:forEach items="${listUserDetail}" var="items">
												<c:if test="${items.status == 'Chưa bắt đầu'}">
													<h3 class="counter text-right m-t-15 text-danger">${items.progressPercent}%</h3>
												</c:if>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<c:forEach items="${listUserDetail}" var="items">
												<c:if test="${items.status== 'Đang thực hiện'}">
													<h3 class="counter text-right m-t-15 text-megna">${items.progressPercent}%</h3>
												</c:if>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<c:forEach items="${listUserDetail}" var="items">
												<c:if test="${items.status == 'Đã  hoàn thành'}">
													<h3 class="counter text-right m-t-15 text-primary">${items.progressPercent}%</h3>
												</c:if>
					...
					<div class="col-md-4">
						<div class="white-box">
							...
							<div class="message-center">
								<c:forEach items="${listUserDetail}" var="items">
									<a href="#"> <c:if test="${items.status == 'Chưa bắt đầu'}">

											<div class="mail-contnet">
												<h5>${items.taskName}</h5>
												<span class="mail-desc"></span> <span class="time">Bắt
													đầu: ${items.startDate}</span> <span class="time">Kết thúc:
													${items.endDate}</span>
											</div>
				...
				<div class="col-md-4">
					<div class="white-box">
						...
						<div class="message-center">
							<c:forEach items="${listUserDetail}" var="items">
								<a href="#"> <c:if
										test="${items.status == 'Đang thực hiện'}">
										<div class="mail-contnet">
											<h5>${items.taskName}</h5>
											<span class="mail-desc"></span> <span class="time">Bắt
												đầu: ${items.startDate}</span> <span class="time">Kết thúc:
												${items.startDate}</span>
										</div>
									</c:if>
								</a>
							</c:forEach>
				...
				<div class="col-md-4">
					<div class="white-box">
						...
						<div class="message-center">
							<a href="#"> <c:forEach items="${listUserDetail}" var="items">
									<c:if test="${items.status == 'Đã hoàn thành'}">
										<h5>${items.taskName}</h5>
										<div class="mail-contnet">
											<span class="mail-desc"></span> <span class="time">Bắt
