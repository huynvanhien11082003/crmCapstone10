							...
							<div class="user-bg">
								...
								<div class="overlay-box">
									<div class="user-content">
										...
										<h4 class="text-white">${userProfile.firstname}
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<h3 class="counter text-right m-t-15 text-danger">${taskProgress.progressPercent}</h3>
										</div>
										<div class="col-xs-12">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="progress">
												<div class="progress-bar progress-bar-danger"
													...
													aria-valuemax="100"
													style="width: ${taskProgress.progressPercent}%"></div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<h3 class="counter text-right m-t-15 text-megna">${taskProgress.progressPercent}%</h3>
										</div>
										<div class="col-xs-12">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<h3 class="counter text-right m-t-15 text-primary">${taskProgress.progressPercent}%</h3>
										</div>
										<div class="col-xs-12">
											<i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
						...
						<div class="white-box">
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										<c:forEach items="${listProfileDTO}" var="items">
											<tr>
												<td>${items.id}</td>
